...
const PurchaseOrderList = () => {
  ...
  useEffect(() => {
    axios
      .get("https://darkslategrey-shrew-424102.hostingersite.com/api/certify_purchase_orders.php")
      .then((res) => {
  ...
  try {
    const response = await axios.post("https://darkslategrey-shrew-424102.hostingersite.com/api/verify_purchase.php", {
      purchase_id: id,
  ...
  <div style={{ marginTop: 50, display: "flex", justifyContent: "space-between" }}>
    ...
    <div style={{ textAlign: "center" }}>
      ...
      (modalData.status === "certify" && (
        <img src="/Signatures/Mam Sign.jpg" alt="My Signature" style={{ width: 100, height: 50, marginBottom: -10 }} />
      )) ||
